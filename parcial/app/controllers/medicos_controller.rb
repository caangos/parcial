class MedicosController < ApplicationController
  before_action :set_medico, only: [:show, :edit, :update, :destroy, :list]
  ...
  private
    ...
    def medico_params
      params.require(:medico).permit(:nombres, :apellidos, :celular, :email, :curriculum, :reconocimientos, :especialidad_id)
    end
end
